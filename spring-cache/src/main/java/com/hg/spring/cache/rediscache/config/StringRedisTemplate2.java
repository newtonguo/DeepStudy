 ...
 * @author Costin Leau
 */
public class StringRedisTemplate2 extends LoggingRedisTemplate<String, String> {

	/**
	 * Constructs a new <code>StringRedisTemplate</code> instance. {@link #setConnectionFactory(RedisConnectionFactory)}
	 * and {@link #afterPropertiesSet()} still need to be called.
	 */
	public StringRedisTemplate2() {
	 ...
	 */
	public StringRedisTemplate2(RedisConnectionFactory connectionFactory) {
		this();
