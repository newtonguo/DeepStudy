...
import com.zhiyin.queue.AliQueueProducerService;
...
public class WebServer {
	 ...
	 * doesn't matter.
	 */
	public static final String SERVICE_URL = "http://Queue-Service";
	 ...
	 */
	@Bean
	public AliQueueProducerService accountsService() {
		return new AliQueueProducerService(SERVICE_URL);
	}
