...
public final class AvatarCreatorImpl implements AvatarCreatorInterface {
    private static final Logger logger = LoggerFactory.getLogger(AvatarCreatorImpl.class);
    ...
    public AvatarCreatorImpl(int imageCount, int baseSize, double fillFactor, float alphaFactor,
    ...
    public void createManyAndCallBack(CallbackFunction<BufferedImage> callback) {
        logInitialization();
        for (int i = 0; i < imageCount; i++) {
            callback.apply(createOne());
        }
    }
