...
import com.zhiyin.hystrix.module.annodemo.RemoteMessageAnnotationClient;
...
private RemoteMessageAnnotationClient messageHandlerService;
    @RequestMapping("/anno")
    public ModelAndView simpleHello() {
        ...
        m.setDelayBy(2000);
        String message = "Welcome to our App, here is a random value : " + messageHandlerService.sendMessage(m).getReceived();
