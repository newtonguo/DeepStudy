...
import com.hg.test.jmeter.sampler.HttpSamplerFactory;
...
public class JMeterFromScratch {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        String jmeterHome1 = "E:\\Software\\apache-jmeter-2.13";
...
//                    HTTPSamplerProxy examplecomSampler = HttpSamplerFactory.google();

        HTTPSamplerProxy examplecomSampler = HttpSamplerFactory.demoWebOk();
