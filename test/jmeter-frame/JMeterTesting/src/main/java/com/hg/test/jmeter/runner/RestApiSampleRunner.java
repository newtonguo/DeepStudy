package com.hg.test.jmeter.runner;

import com.hg.test.api.HttpSamplerFactory;
...
*/
public class RestApiSampleRunner {
    ...
    public static void main(String[] argv) throws Exception {
        ...
        if (jmeterHome.exists()) {
            ...
            if (jmeterProperties.exists()) {
                ...
                threadGroupHashTree.add(man);


                threadGroupHashTree.add(HttpSamplerFactory.genByExcel(""));
